...
Reading status: `[ ]` unread, `[x]` read. Depth: `👀` quick read, `📚` deep read.
...
### Model Architecture and Residual Design
...
### Efficient, Linear, and Gated Attention
...
### Distributed Long-Context Training
...
### Automatic Parallelization and Planning
...
- [x] [FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness](https://doi.org/10.48550/arXiv.2205.14135) 👀
